...
| `e031866` | `3affb651cbb` | PENDING | Midpoint after the fast-path checkpoint and I-cache-miss escape; clean traced CSR-isolation simulation passed. |
...
The regression is therefore in the later BP sequence:
