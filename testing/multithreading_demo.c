...
int main(int argc, char** argv) {
  ...
  /* Seed thread 1's sp (x2) and gp (x3), then seed its entry NPC */
  seed_thread_reg(1, 3 /*x3=gp*/, gp_val);
  ...
  /* Seed thread 2's sp (x2) and gp (x3), then seed its entry NPC */
  seed_thread_reg(2, 3 /*x3=gp*/, gp_val);
  ...
  /* Seed thread 3's sp (x2) and gp (x3), then seed its entry NPC */
  seed_thread_reg(3, 3 /*x3=gp*/, gp_val);
