...
static uint64_t thread1_stack[256] __attribute__((used));  /* 2 KB */

/* C body of thread 1's work — called after sp is set up. */
static void __attribute__((noinline, used)) thread1_main(void) {
