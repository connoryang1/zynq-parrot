/**
 * Shared body for controlled-gap ctxtsw microbench variants.
 *
...
#if CTXTSW_GAP_INSNS == 1
  __asm__ volatile("addi x0, x0, 0" ::: "memory");
#elif CTXTSW_GAP_INSNS == 2
  __asm__ volatile(
    "addi x0, x0, 0\n"
    "addi x0, x0, 0\n"
    ::: "memory"
  );
#elif CTXTSW_GAP_INSNS == 4
  __asm__ volatile(
    "addi x0, x0, 0\n"
    "addi x0, x0, 0\n"
    "addi x0, x0, 0\n"
...
#else
#error "Unsupported CTXTSW_GAP_INSNS"
#endif
}
...
int main(void) {
  ...
  restore_gp();
  bp_print_string("=== Context Switch Gap Microbenchmark ===\n");
