...
int main() {
  ...
  d.alloc_v_i = d.issue_v_i = d.response_v_i = d.response_last_i = 0;
  d.issue_id_i = d.response_id_i = 0; reset(d);
  ...
  d.response_id_i = 1; d.response_v_i = d.response_last_i = 1; d.eval(); assert(d.response_ready_o); tick(d, 0); d.response_v_i = d.response_last_i = 0;
