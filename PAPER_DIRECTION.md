...
and verifies register restoration. See [Linux acceptance](CURRENT_CHECKOUT.md#fpga-acceptance-identities)
...
[the history checkpoint](CURRENT_CHECKOUT.md#history-and-recovery).
