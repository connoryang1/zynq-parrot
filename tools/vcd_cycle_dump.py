...
WATCH = [
    ...
    ("dcache_uce.cache_req_v_i$", "uce_req_v"),
    ("dcache_uce.cache_req_yumi_o$", "uce_req_yumi"),
    ("dcache_uce.cache_req_v_r$", "uce_req_r_v"),
    ("dcache_uce.cache_req_done$", "uce_req_done"),
    ("dcache_uce.cache_req_metadata_v_i$", "uce_meta_v"),
    ("dcache_uce.cache_req_metadata_v_r$", "uce_meta_r_v"),
    ("dcache_uce.cache_req_metadata_v$", "uce_meta_any_v"),
    ("dcache_uce.cache_req_ready_lo$", "uce_req_ready"),
    ("dcache_uce.cache_req_r.msg_type$", "uce_req_r_type"),
    ("dcache_uce.cache_req_cast_i.msg_type$", "uce_req_i_type"),
    ("dcache_uce.cache_req_cast_i.addr$", "uce_req_i_addr"),
    ("dcache_uce.cache_req_r.addr$", "uce_req_r_addr"),
    ("dcache_uce.state_r$", "uce_state"),
    ("dcache_uce.fsm_fwd_v_lo$", "uce_fwd_v"),
    ("dcache_uce.fsm_fwd_ready_then_li$", "uce_fwd_ready"),
    ("dcache_uce.fsm_fwd_new_lo$", "uce_fwd_new"),
    ("dcache_uce.fsm_fwd_last_lo$", "uce_fwd_last"),
    ("dcache_uce.fsm_rev_v_li$", "uce_rev_v"),
    ("dcache_uce.fsm_rev_yumi_lo$", "uce_rev_yumi"),
    ("dcache_uce.fsm_rev_last_li$", "uce_rev_last"),
    ("dcache_uce.credit_count_lo$", "uce_credit"),
    ("dcache_uce.cache_req_credits_full_o$", "uce_credit_full"),
    ("dcache_uce.cache_req_credits_empty_o$", "uce_credit_empty"),
    ("dcache_uce.prefetch_valid_r$", "uce_pf_valid"),
    ...
    ("be.detector.csr_rs1_haz_v$", "det_csr_rs1_haz"),
    ("be.detector.csr_trans_haz_v$", "det_csr_trans_haz"),
    ("be.detector.data_haz_v$", "det_data_haz"),
    ("be.detector.control_haz_v$", "det_control_haz"),
    ("be.detector.hazard_v_o$", "det_hazard"),
    ("be.detector.dep_thread_id_r[0]$", "det_dep0_tid"),
    ("be.detector.dep_thread_id_r[1]$", "det_dep1_tid"),
    ("be.detector.dep_thread_id_r[2]$", "det_dep2_tid"),
    ("be.detector.dep_thread_id_r[3]$", "det_dep3_tid"),
    ("be.detector.dep_status_r[0].rd_addr$", "det_dep0_rd"),
    ("be.detector.dep_status_r[0].eint_iwb_v$", "det_dep0_eint"),
    ("be.detector.dep_status_r[0].fint_iwb_v$", "det_dep0_fint"),
    ("be.detector.dep_status_r[0].trans_info_v$", "det_dep0_trans"),
    ("be.detector.dep_status_r[1].rd_addr$", "det_dep1_rd"),
    ("be.detector.dep_status_r[1].eint_iwb_v$", "det_dep1_eint"),
    ("be.detector.dep_status_r[1].fint_iwb_v$", "det_dep1_fint"),
    ("be.detector.dep_status_r[1].trans_info_v$", "det_dep1_trans"),
    ("be.detector.dep_status_r[2].trans_info_v$", "det_dep2_trans"),
    ("be.detector.dep_status_r[3].trans_info_v$", "det_dep3_trans"),
    ("be.scheduler.fe_queue_roll_li$", "roll"),
    ("be.scheduler.fe_queue_en_li$", "iq_en"),
    ("be.scheduler.fe_queue_read_li$", "iq_read"),
    ("be.scheduler.issue_ctxtsw_v$", "issue_ctxtsw"),
    ("be.scheduler.issue_ctxtsw_target_tid$", "issue_ctxtsw_tid"),
    ("be.scheduler.issue_ctxtsw_dispatch_v$", "issue_ctxtsw_disp"),
    ("be.scheduler.issue_pkt_cast_o.csrw$", "issue_csrw"),
    ("be.scheduler.issue_pkt_cast_o.decode.csr_w_v$", "issue_decode_csr_w"),
    ...
    ("be.scheduler.ptw.busy_o$", "ptw_busy"),
    ("be.scheduler.ptw.v_o$", "ptw_v"),
    ("be.scheduler.ptw.walk_o$", "ptw_walk"),
    ("be.scheduler.ptw.dtlb_fill_o$", "ptw_dtlb_fill"),
    ("be.scheduler.ptw.load_page_fault_o$", "ptw_ld_fault"),
    ("be.scheduler.ptw.addr_o$", "ptw_addr"),
    ("be.scheduler.ptw.pte_o$", "ptw_pte"),
    ("be.scheduler.ptw.v_i$", "ptw_data_v"),
    ("be.scheduler.ptw.data_i$", "ptw_data"),
    ("be.scheduler.ptw.trans_info_cast_i.base_ppn$", "ptw_base_ppn"),
    ("be.scheduler.ptw.trans_info_cast_i.translation_en$", "ptw_trans_en"),
    ("be.scheduler.ptw.trans_info_cast_i.priv_mode$", "ptw_priv"),
    ("be.scheduler.ptw.state_r$", "ptw_state"),
    ("be.scheduler.ptw.dcache_pte.ppn$", "ptw_pte_ppn"),
    ("be.scheduler.ptw.dcache_pte.r$", "ptw_pte_r"),
    ("be.scheduler.ptw.dcache_pte.w$", "ptw_pte_w"),
    ("be.scheduler.ptw.dcache_pte.x$", "ptw_pte_x"),
    ("be.scheduler.ptw.dcache_pte.v$", "ptw_pte_v"),
    ("be.scheduler.ptw.ppn_r$", "ptw_ppn_r"),
    ("be.scheduler.ptw.ppn_n$", "ptw_ppn_n"),
    ("be.scheduler.ptw.level_r$", "ptw_level_r"),
    ("be.scheduler.ptw.level_n$", "ptw_level_n"),
    ("be.scheduler.ptw.writeback_ppn$", "ptw_wb_ppn"),
    ("be.scheduler.ptw.walk_start$", "ptw_walk_start"),
    ("be.scheduler.ptw.walk_next$", "ptw_walk_next"),
    ("be.scheduler.ptw.walk_done$", "ptw_walk_done"),
    ("be.scheduler.ptw.walk_addr$", "ptw_walk_addr"),
]
